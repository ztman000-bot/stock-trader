...
KRX_OFFICIAL_ENSURE="$PWD/ensure_krx_official_collector.sh"
...
# Historical reference collector is isolated from NH/Paper. It prefers a compact
# keyless GitHub market-regime aggregate built off-device from FinanceData/marcap.
# data.go.kr and KRX remain optional official cross-checks. Network work waits for
# the EOD research window and never changes Control/Paper behavior.
...
echo "- Historical reference: GitHub regime aggregate first; data.go.kr/KRX optional cross-check"
