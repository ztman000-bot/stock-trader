...
- 좋은 매매위치 TOP10 스캐너
- 100점 전략 점수(Trend/Momentum/Volume/Price/Risk)
...
## 실행
보안상 ES Module을 사용하므로 파일을 직접 더블클릭하기보다 로컬 서버로 실행하세요.
...
현재 `app.js`는 `MockBroker`를 사용합니다. NH 문서가 확보되면 `nhAdapter.js`가 아래 기능을 구현하도록 확장합니다.
